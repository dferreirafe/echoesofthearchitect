		...
		match drag_state:
			DragState.right:
				...
				if current_object.centered:
					current_object.global_position = Vector2(
						snappedf(
							starting_current_object_global_rect.position.x + (starting_current_object_global_rect.size.x / 2.0) + (distance / 2.0),
							grid_size / 2.0
						),
			...
			DragState.bottom:
				...
				if current_object.centered:
					current_object.global_position = Vector2(
						...
						snappedf(
							starting_current_object_global_rect.position.y + (starting_current_object_global_rect.size.y / 2.0) + (distance / 2.0),
							grid_size / 2.0,
						),
					)
			...
			DragState.left:
				...
				if current_object.centered:
					...
					current_object.global_position = Vector2(
						snappedf(
							starting_current_object_global_rect.position.x + distance,
							grid_size,
						),
						current_object.global_position.y,
					)
			...
			DragState.top:
				...
				if current_object.centered:
					...
					current_object.global_position = Vector2(
						current_object.global_position.x,
						snappedf(
							starting_current_object_global_rect.position.y + distance,
							grid_size,
						),
					)
